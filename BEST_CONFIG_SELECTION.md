...
## Verified Submission State (pose-value confirmed, 2026-05-14)

Source config for each file in the current submission, confirmed by matching inner pose XYZ values (err < 0.02 m) against all candidate result directories. "EXTRAP" = submission extends beyond source pose window via constant-velocity extrapolation.

| Run | Submitted config | Extrapolated? | Notes |
|-----|-----------------|---------------|-------|
| floor_1 / 2025-05-05 / run_1 | baseline 1× | yes (back 1.9 s, fwd 1.7 s) | should be vi_ready — never updated |
| floor_1 / 2025-07-07 / run_1 | dynA 0.5× | no | |
| floor_1 / 2025-12-02 / run_1 | dynA 0.5× | no | MD incorrectly said dynA 1× |
| floor_2 / 2025-05-05 / run_1 | vi_ready (baseline 0.5×) | no | |
| floor_2 / 2025-10-28 / run_1 | dynA 0.5× | no | |
| floor_2 / 2025-10-28 / run_2 | dynA 0.5× | no | |
| floor_2 / 2025-12-02 / run_1 | dynA 0.5× | yes (back 9.4 s, fwd 1.7 s) | |
| floor_2 / 2025-12-03 / run_1 | fastinit 0.5× | yes (back 7.6 s, fwd 1.5 s) | not yet analysed |
| floor_3 / 2025-05-19 / run_1 | dynA 0.5× | no | |
| floor_3 / 2025-12-02 / run_1 | fastinit 0.5× | no | not yet analysed |
| floor_4 / 2025-05-19 / run_1 | dynA 0.5× | no | not yet analysed |
| floor_4 / 2025-12-02 / run_1 | dynA 1× | no | interpolation only |
| floor_5 / 2025-12-02 / run_1 | fastinit 0.5× | yes (back 7.6 s, fwd 1.7 s) | not yet analysed |
| floor_6 / 2025-06-18 / run_1 | imuB 0.5× | no | not yet analysed |
| floor_6 / 2025-07-07 / run_1 | fastinit 0.5× | no | |
| floor_6 / 2025-12-02 / run_1 | fastinit 0.5× | no | not yet analysed |
| floor_6 / 2025-12-02 / run_2 | fastinit 0.5× | yes (back 6.6 s, fwd 1.7 s) | not yet analysed |
| floor_7 / 2025-12-02 / run_1 | fastinit 0.5× | yes (back 9.8 s, fwd 1.7 s) | |
| floor_7 / 2025-12-02 / run_2 | dynA 0.5× | no | interpolation only |
| floor_7 / 2025-12-03 / run_1 | dynA 0.5× | yes (back 6.5 s, fwd 0 s) | |
| floor_EG / 2025-10-16 / run_1 | dynA 0.5× | no | not yet analysed |
| floor_EG / 2025-12-02 / run_1 | fastinit 0.5× | no | |
| floor_EG / 2025-12-02 / run_2 | imuB_dynfastinit 0.5× | yes (back 6.9 s, fwd 1.7 s) | |
| floor_UG1 / 2025-05-19 / run_1 | dynA 0.5× | no | not yet analysed |
| floor_UG1 / 2025-06-18 / run_1 | fastinit 0.5× | no | not yet analysed |
| floor_UG1 / 2025-10-16 / run_1 | vi_ready (baseline 0.5×) | no | |
| floor_UG1 / 2025-12-02 / run_1 | dynA 0.5× | no | |
| floor_UG1 / 2025-12-02 / run_2 | fastinit 0.5× | no | |
| floor_UG1 / 2025-12-03 / run_1 | fastinit 0.5× | yes (back 6.8 s, fwd 1.5 s) | not yet analysed |
| floor_UG2 / 2025-12-02 / run_1 | fastinit 0.5× | no | not yet analysed |
...
**Current submission uses:** baseline 1× upsampled (ATE 0.687 m) — confirmed by pose-value match. The vi_ready rerun was identified as the best config but was never applied to the submission file.
...
**Selected:** `dynA (0.5×)` — submission uses dynA slowrate (confirmed by pose-value matching). MD previously said dynA 1× but that was never applied; the submission file matches dynA_slow. Coverage ~77.4%; expC and other configs diverged.
